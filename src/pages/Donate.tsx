        ...
        <div className="container mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground">
              Share your surplus, spread smiles
            </p>
          </div>
        </div>
      </header>
            ...
            <div className="bg-card rounded-2xl p-6 md:p-8 shadow-soft border border-border">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="description"
                    placeholder="What kind of food is it? (e.g., Rice, Dal, Roti, Vegetable curry)"
                    rows={3}
          ...
          {step === 3 && (
            ...
            >
              ...
              <p className="text-muted-foreground mb-8 max-w-md mx-auto">
                Your donation has been posted. We're matching it with nearby NGOs and
                volunteers. You'll receive an update shortly.
              </p>

              <div className="bg-accent rounded-xl p-4 mb-8">
                <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
                  <div className="w-2 h-2 bg-warning rounded-full animate-pulse-soft" />
                  Looking for nearby receivers...
                </div>
              </div>
